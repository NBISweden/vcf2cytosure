...
def main():
    ...
    group.add_argument(
        ...
        required=False,
        default=37,
        help="Human genome version. Use 37 for GRCh37/hg19, 38 for GRCh38 template.",
    )
    group.add_argument(
        "--sex",
        required=False,
    ...
    group.add_argument(
        "--snv",
        type=str,
        help="snv vcf file, use coverage annotation to position the height of the probes(cannot be used together with --coverage)",
    )
    group.add_argument(
        "--dp",
        type=str,
        default="DP",
        help="read depth tag of snv vcf file. This option is only used if you use snv to set the heigth of the probes. The dp tag is a tag which is used to retrieve the depth of coverage across the snv (default=DP)",
    )
    group.add_argument(
        "--maxbnd",
        type=int,
